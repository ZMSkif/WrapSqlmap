...
# Проверка ссылок на популярные домены
Check_List = False
...
# Колонки для дампов
COLUMN_DUMP = 'user,post,Poștă,pošta,posta,Poczta,poster,Paštas,correspondência,correo,posta,e-posta,clave,parola,wachtwoord,Heslo,hasło,senha,mail,pass,pw,salt,solt,hash,md5,sha1,hex'
